...
const BasemapButton = ({ buttonText, layerParameter, submitFunction, img }) => {
  ...
  return (
    <div className='border border-lime-200 p-1 rounded-md bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 h-16 w-16 md:h-20 md:w-20'>
      ...
      <p className='text-lime-200 text-center text-xs md:text-sm'>{buttonText}</p>
    </div>
